<?php
    ...
    if(isset($_GET['delete_id'])) {
        ...
        $delete_query = $db->prepare("DELETE FROM premium WHERE pid = :delete_id");
        $delete_query->bindValue(':delete_id', $delete_id, PDO::PARAM_INT);
        $delete_query->execute();
        header("Location: userpremiumlist.php"); // Redirect after delete
        exit();
    }
?>
                    ...
                    <div id="form">
                        <table>
                            <tr>
                                ...
                                <td><center><b><font color="blue">Card Number</font></b></center></td>
                                <td><center><b><font color="blue">Card Expiry Date</font></b></center></td>
                                <td><center><b><font color="blue">Customer Address</font></b></center></td>
                                <td><center><b><font color="blue">Actions</font></b></center></td>
                            </tr>
                            <?php
                                $q = $db->query("SELECT * FROM premium ");
                                while ($r1 = $q->fetch(PDO::FETCH_OBJ)) {
                                    ?>
                                    <tr>
                                        <td><center><?= $r1->pname; ?></center></td>
                                        <td><center><?= $r1->pemail; ?></center></td>
                                        <td><center><?= $r1->pcno; ?></center></td>
                                        <td><center><?= $r1->pcardno; ?></center></td>
                                        <td><center><?= $r1->pexpirydate; ?></center></td>
                                        <td><center><?= $r1->paddress; ?></center></td>

                                        <td>
                                            <a href="edit-userpremiumlist.php?id=<?= $r1->pid; ?>">Edit</a> |
                                            <a href="?delete_id=<?= $r1->pid; ?>" onclick="return confirm('Are you sure you want to delete this entry?')">Delete</a>
                                        </td>
                                    </tr>
                            <?php
                                }
